...
The performance of FTS will be judged by measuring relative delays of pulses generated by two different ESP32 S3 SoCs (slaves) aligned to a third one (master) over WiFi FTM. On the photo below, these pulses are visualized on an oscilloscope:
